...
def parse_args_and_config():
    ...
    parser.add_argument('--edit_img_number', type=int, default=19, help='Number of editing images')
    ...
    parser.add_argument('--boundary_h', type=str, default=None, help='boundary_h')
    parser.add_argument('--boundary_z', type=str, default=None, help='boundary_z')
    ...
    parser.add_argument('--save_test_image', type=str, default=None, help='Wheter to save training results during CLIP fineuning')
